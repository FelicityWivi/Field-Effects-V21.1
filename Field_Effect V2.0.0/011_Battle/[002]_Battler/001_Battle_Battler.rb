class Battle::Battler
  ...
  #=============================================================================
  # Mega Evolution, Primal Reversion, Shadow Pokémon, Aberration, Ancient
  #=============================================================================
  def hasMega?
  ...
  def aberration?; return @pokemon&.aberration?; end

  def livnan?; return @pokemon&.livnan?; end

  def ancient?; return @pokemon&.ancient?; end

  def convergent?; return @pokemon&.convergent?; end
